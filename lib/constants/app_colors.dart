...
class AppColors {
  ...
  static const Color surfaceContainerLow = Color(0xFFF1F4F7);
  static const Color surfaceContainer = Color(0xFFEBEEF1);
  ...
  static const Color amber = Color(0xFFFFBA20);
  static const Color gold = Color(0xFFB8860B);
  static const Color blue = Color(0xFF0066FF);

  // Status Colors
  static const Color success = Color(0xFF008072);
